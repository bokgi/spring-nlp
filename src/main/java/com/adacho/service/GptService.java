...
public class GptService {
	...
	public GptResponseDto getGptComment(String userInput, List<Integer> recommandList) {
		...
		String gptInput = "사용자 입력: \"" + userInput + "\"\n" +
                ...
                sb.toString() + "\n\n" + 
                "1. 위 목록의 식당 중에서 사용자 입력과 연관되어 있는 식당 10개 이상 선택하세요.\n" +
                "2. 선택한 식당들에 대해 설명하세요.\n" +
                "조건 1: 식당 설명 순서는 위 식당 목록 순서를 따라야합니다.\n\n" +
                "조건 2: 결론에는 반드시 '감사합니다.' 만 생성하세요.\n\n"+
                "설명시 반드시 지켜야하는 부분은 다음과같습니다.\n " +
                ...
                "이삭토스트 정릉점: [간단한 식당 정보 요약 - 예: 트렌디한 분위기에서 독창적인 퓨전 요리를 즐길 수 있는 공간이에요.] [추천 대상 - 예: 새로운 맛에 도전하는 것을 즐기는 젊은 미식가]라면 꼭 방문해 보세요! 평점은 [평점]점으로 괜찮은 편이며, 리뷰를 보면 [긍정적 피드백 - 예: 메뉴 구성이 독특하고 플레이팅이 아름답다]는 이야기가 많아요. [평점이 낮은 편이라면 이유 포함 - 예: 반면에, 일부 메뉴는 호불호가 갈릴 수 있다는 의견도 있네요.]\n\n" +                
                "감사합니다.";
