...
public class GptService {
	...
	public GptResponseDto getGptComment(String userInput, List<Integer> recommandList) {
		...
		String gptInput = "사용자 입력: \"" + userInput + "\"\n" +
                ...
                "- 각 설명은 [식당 이름: 식당에 대한 설명 내용] 형태로 시작하며, **친절하고 자연스러운 대화체 어조**를 사용하되, 각 식당마다 **다양한 표현**를 사용해야 합니다.\n" +
                "- 설명에 특수문자, 특수효과(기울임,굵게 등) 사용하지 마세요.\n" +
                "- 만약 식당이름에 특수문자가 들어있다면 특수문자를 포함해서 그대로 출력하세요.\n\n" +
        		"위 목록에 있는 식당들을 목록에 나타나는 순서대로 설명해 주세요.\n" +
        		"설명은 아래 예시와 같이작성하고, **식당 설명 사이에 순서를 암시하는 연결 어구(마지막으로, 다음으로, 두 번째 등)는 절대 사용하지 않습니다. \n\n" +
                "--- 설명 형식 예시 ---\n" + 
        		"[자연스럽고 친근한 인삿말]\n" +
