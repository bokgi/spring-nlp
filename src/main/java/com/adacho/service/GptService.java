...
public class GptService {
	...
	public GptResponseDto getGptComment(String userInput, List<Integer> recommandList) {
		...
		String gptInput = "사용자 입력: \"" + userInput + "\"\n" +
                ...
                sb.toString() + "\n\n" + 
                "1. 위 목록에 있는 식당 중에서 사용자 입력과 연관되어 있는 식당 10개 이상 선택해주세요.\n" +
                ...
                "--- 설명 형식 예시 ---\n" + 
        		"[자연스럽고 친근한 인삿말]\n" +
                "선택한 식당 이름 1: [간단한 식당 정보 요약 - 예: 신선한 해산물 요리를 전문으로 하는 이곳은 바닷가 마을에 온 듯한 편안한 분위기가 매력적이에요.] 특히 [추천 대상 - 예: 해산물 요리를 좋아하고 정겨운 분위기를 찾는 분들]께 강력 추천합니다. 방문객 평점은 [평점]점으로 상당히 높아요. 많은 리뷰에서 [좋았던 점 - 예: 재료 신선도와 직원분들의 친절함]을 칭찬했고, [아쉬웠던 점 - 예: 다만, 인기가 많아 웨이팅이 있을 수 있다는 점]도 참고하시면 좋습니다.\n\n" + 
                "선택한 식당 이름 2: [간단한 식당 정보 요약 - 예: 트렌디한 분위기에서 독창적인 퓨전 요리를 즐길 수 있는 공간이에요.] [추천 대상 - 예: 새로운 맛에 도전하는 것을 즐기는 젊은 미식가]라면 꼭 방문해 보세요! 평점은 [평점]점으로 괜찮은 편이며, 리뷰를 보면 [긍정적 피드백 - 예: 메뉴 구성이 독특하고 플레이팅이 아름답다]는 이야기가 많아요. [평점이 낮은 편이라면 이유 포함 - 예: 반면에, 일부 메뉴는 호불호가 갈릴 수 있다는 의견도 있네요.]\n\n" +                
                "감사합니다.";
